...
public class LibraryEventsControllerIntegrationTest {
	...
	void postLibraryEvent() throws InterruptedException {
		...
		// Thread.sleep(3000);
		String expectedRecord = "{\"libraryEventId\":null,\"libraryEventType\":\"NEW\",\"book\":{\"bookId\":123,\"bookName\":\"test\",\"bookAuthor\":\"ankit\"}}";
	...
	void putLibraryEvent() throws InterruptedException {
		// given
		Book book = Book.builder().bookId(456).bookAuthor("Ankit").bookName("Kafka using Spring Boot").build();
		...
		ConsumerRecord<Integer, String> consumerRecord = KafkaTestUtils.getSingleRecord(consumer, "library-events");
		// Thread.sleep(3000);
		String expectedRecord = "{\"libraryEventId\":123,\"libraryEventType\":\"UPDATE\",\"book\":{\"bookId\":456,\"bookName\":\"Kafka using Spring Boot\",\"bookAuthor\":\"Ankit\"}}";
		String value = consumerRecord.value();
		assertEquals(expectedRecord, value);
	}
}
